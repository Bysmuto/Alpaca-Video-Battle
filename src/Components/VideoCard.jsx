...
export function PedroCard({ videoId, vote, isRight }) {
  return (
    <motion.div
      initial={{ x: isRight ? "-80vw" : "80vw" }}
      animate={{ x: 0 }}
      ...
      className="space-y-5 flex flex-col items-center justify-center h-[70vh]  md:h-[60vh] md:w-[40vw] md:m-4 "
    >
      <YoutubeVideo videoId={videoId} extra="border-yellow-500 " />
      <Button
        name="vote"
        func={vote}
        extra="w-full  font-bold border-yellow-900 font-bold 
              bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 
              via-blue-500 via-purple-500 to-pink-500 bg-[length:200%_200%] hover:bg-white animate-gradient
